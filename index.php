...
<html lang="en">
  <head>
    ...
    <title>Animations using JavaScript, CSS, SVG, HTML5 Canvas, anime.js, jQuery</title>
    ...
    <div id="page-wraper">
        ...
        <div id="menu" class="menu">
          ...
          <div class="container">
            ...
            <nav class="main-nav" role="navigation">
              <ul class="main-menu">
                <li><a href="#section1">Animation 1</a></li>
                <li><a href="#section2">Animation 2</a></li>
                <li><a href="#section3">Animation 3</a></li>
                <li><a href="#section4">Animation 4</a></li>
                <li><a href="#section5">Animation 5</a></li>
              </ul>
            </nav>
          </div>
        </div>
      ...
      <section class="section about-me" data-section="section1">
        <div class="section-heading">
            ...
            <span>Select picture, move to left or right</span>
        </div>
        <div id="canvas"></div>
        <div id="planes">
                ...
                <div class="grid__item">
                  <div class="grid__link pater">
                    ...
                    <div class="pater__content">
                      <h2 class="pater__title" aria-label="fullstory">Click buttons</h2>
                    </div>
                  </div>
                </div>
                <div class="grid__item">
